...
//+kubebuilder:webhook:path=/mutate-batch-demo-welcome-domain-v1-cronjob,mutating=true,failurePolicy=fail,sideEffects=None,groups=batch.demo.welcome.domain,resources=cronjobs,verbs=create;update,versions=v1,name=mcronjob.kb.io,admissionReviewVersions=v1
...
func (r *CronJob) validateCronJob() error {
	...
	return apierrors.NewInvalid(schema.GroupKind{Group: "batch.demo.welcome.domain", Kind: "CronJob"}, r.Name, allErrs)
}
