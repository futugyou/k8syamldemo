...
//+kubebuilder:rbac:groups=apps.demo.welcome.domain,resources=simpledeployments,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=apps.demo.welcome.domain,resources=simpledeployments/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=apps.demo.welcome.domain,resources=simpledeployments/finalizers,verbs=update
