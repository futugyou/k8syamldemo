...
#########  housekeeping
```
yum -y install  conntrack conntrack-tools ntpdate ntp ipvsadm ipset jq iptables curl sysstat libseccomp wget wgetvimnet-tools vim vim-enhanced   net-tools net-toolsbind-utils socat git iproute iptable-services lrzsz hash-completion tree bridge-utils unzip bind-utils gcc
